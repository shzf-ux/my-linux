...
void Vencoder42___024root__trace_chg_sub_0(Vencoder42___024root* vlSelf, VerilatedVcd::Buffer* bufp);

void Vencoder42___024root__trace_chg_top_0(void* voidSelf, VerilatedVcd::Buffer* bufp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vencoder42___024root__trace_chg_top_0\n"); );
    // Init
    ...
    // Body
    Vencoder42___024root__trace_chg_sub_0((&vlSymsp->TOP), bufp);
}

void Vencoder42___024root__trace_chg_sub_0(Vencoder42___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    if (false && vlSelf) {}  // Prevent unused
    Vencoder42__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vencoder42___024root__trace_chg_sub_0\n"); );
    // Init
...
void Vencoder42___024root__trace_cleanup(void* voidSelf, VerilatedVcd* /*unused*/) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vencoder42___024root__trace_cleanup\n"); );
    // Init
    Vencoder42___024root* const __restrict vlSelf VL_ATTR_UNUSED = static_cast<Vencoder42___024root*>(voidSelf);
    Vencoder42__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
