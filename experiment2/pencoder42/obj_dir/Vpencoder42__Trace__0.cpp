...
void Vpencoder42___024root__trace_chg_sub_0(Vpencoder42___024root* vlSelf, VerilatedVcd::Buffer* bufp);

void Vpencoder42___024root__trace_chg_top_0(void* voidSelf, VerilatedVcd::Buffer* bufp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vpencoder42___024root__trace_chg_top_0\n"); );
    // Init
    ...
    // Body
    Vpencoder42___024root__trace_chg_sub_0((&vlSymsp->TOP), bufp);
}

void Vpencoder42___024root__trace_chg_sub_0(Vpencoder42___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    if (false && vlSelf) {}  // Prevent unused
    Vpencoder42__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vpencoder42___024root__trace_chg_sub_0\n"); );
    // Init
    ...
    bufp->chgIData(oldp+3,(vlSelf->pencoder42__DOT__i),32);
}

void Vpencoder42___024root__trace_cleanup(void* voidSelf, VerilatedVcd* /*unused*/) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vpencoder42___024root__trace_cleanup\n"); );
    // Init
    Vpencoder42___024root* const __restrict vlSelf VL_ATTR_UNUSED = static_cast<Vpencoder42___024root*>(voidSelf);
    Vpencoder42__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
